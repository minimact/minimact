...
import { Form, Steps, InputNumber, message, Divider } from 'antd';
...
import FailSquareSelect from '../components/FailSquareSelect';
...
${formData.resourceLinks?.length ? `\n## Resources\n${formData.resourceLinks.map(l => `- ${l}`).join('\n')}` : ''}
      ...
      const command = {
        ...
        tagCategories: [{
          name: 'domain',
          tags: formData.domain ? [formData.domain] : []
        }],
        isDraft: true
      };
      await failuresService.createFailure(command);
  ...
  const handleSubmit = async () => {
    if (!user) {
      message.error('You must be logged in to submit a failure');
      navigateToTab('/login', 'Login');
      return;
    }
    try {
...
${formData.resourceLinks?.length ? `\n## Resources\n${formData.resourceLinks.map(l => `- ${l}`).join('\n')}` : ''}
      ...
      // Call API
      const createdPost = await failuresService.createFailure(command);
      message.success('Failure documented successfully!');
      navigateToTab(`/failures/${createdPost.id}`, createdPost.title, {
        closable: true
      });
    } catch (error) {
      ...
      if (error?.errors) {
        ...
        message.error('Failed to submit failure documentation');
      }
    } finally {
        ...
        return /*#__PURE__*/_jsxs(_Fragment, {
          children: [/*#__PURE__*/_jsx(Form.Item, {
            ...
            children: /*#__PURE__*/_jsx(FailSquareSelect, {
              ...
              options: [{
                value: 'quantum',
                label: 'Quantum Computing Square'
              }, {
                value: 'neural',
                label: 'Neural Architecture Square'
              }, {
                value: 'distributed',
                label: 'Distributed Systems Square'
              }]
            })
          }), /*#__PURE__*/_jsx(Form.Item, {
            label: "Tags",
            ...
            children: /*#__PURE__*/_jsx(FailSquareSelect, {
              ...
              options: []
              // Note: For tags mode, we might need to enhance FailSquareSelect or use a different approach
            })
          })]
        });
      case 1:
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsx(FailSquareButton, {
            ...
            children: [/*#__PURE__*/_jsx("h1", {
              ...
              children: "Document a Failure"
            }), /*#__PURE__*/_jsx("p", {
              className: "text-gray-600",
              children: "Help others learn from what didn't work"
            })]
          })]
        }), /*#__PURE__*/_jsxs("div", {
        ...
        children: /*#__PURE__*/_jsxs(FailSquareCard, {
          children: [/*#__PURE__*/_jsx(Steps, {
            ...
            children: [/*#__PURE__*/_jsx(FailSquareButton, {
              ...
              onClick: handleSubmit,
              loading: isSubmitting,
              children: "Submit Failure Documentation"
            })]
          })]
        })
      }), /*#__PURE__*/_jsxs("div", {
...
export default SubmitFailurePage;