...
import { MultiResolutionTester } from './multi-resolution.js';
...
export class VisualCompiler {
     ...
     */
    async analyzeContent(htmlContent, sourcePath, options) {
     ...
     * Save report to file
     */
    async saveReport(report, sourcePath) {
        if (!this.config.outputPath)
            return;
     ...
     */
    static createTestFile(content, fileName = 'test-component.html') {
