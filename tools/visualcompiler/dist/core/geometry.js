export class GeometryEngine {
     ...
     */
    static checkViewportOverflow(component, viewport) {
     ...
     */
    static checkAlignment(a, b, tolerance = 2) {
        return {
     ...
     */
    static analyzeLayout(components, resolution) {
        const issues = [];
