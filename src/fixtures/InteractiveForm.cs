...
public partial class InteractiveForm : MinimactComponent
{
    ...
    protected override VNode Render()
    {
        ...
        return new VElement("form", "1", new Dictionary<string, string> { ["class"] = "form", ["onsubmit"] = "handleSubmit" }, new VNode[]
        {
            new VElement("div", "1.1", new Dictionary<string, string> { ["class"] = "form-group" }, new VNode[]
            {
                new VElement("label", "1.1.1", new Dictionary<string, string> { ["htmlFor"] = "name" }, "Name:"),
            ...
            {
                new VElement("label", "1.2.1", new Dictionary<string, string> { ["htmlFor"] = "email" }, "Email:"),
