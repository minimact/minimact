...
function useDynamicState(initialState) {
     ...
     */
    const registerBinding = (selector, fn) => {
     ...
     */
    const registerOrderBinding = (containerSelector, fn) => {
        // Track dependencies
     ...
     * Update state
     */
    const updateState = (updaterOrPartial) => {
    ...
    api.remove = (selector) => bindings.delete(selector);
    return api;
}
