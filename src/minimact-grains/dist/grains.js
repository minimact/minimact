var MinimactGrains = (function (exports, core) {
    'use strict';
    ...
    function useGrain(grainId) {
        const registry = getGrainRegistry();
        const isRegistered = core.useRef(false);
        core.useEffect(() => {
    ...
    function useGrainReducer(reducer, initialState, reducerName) {
        const [state, setState] = core.useState(initialState);
    ...
    exports.activateGrain = activateGrain;
    exports.addVectors = addVectors;
    exports.assignReward = assignReward;
    exports.batchAssignRewards = batchAssignRewards;
    exports.calculateEntropy = calculateEntropy;
    exports.calculateMaxEntropy = calculateMaxEntropy;
    exports.calculateUncertainty = calculateUncertainty;
    exports.computeCausalStrength = computeCausalStrength;
    exports.computeCombinedCausalStrength = computeCombinedCausalStrength;
    exports.computeEligibilityTrace = computeEligibilityTrace;
    exports.computeSpatialCausalStrength = computeSpatialCausalStrength;
    exports.computeTemporalCreditAssignment = computeTemporalCreditAssignment;
    exports.conditionalReward = conditionalReward;
    exports.confidence = confidence;
    exports.cosineSimilarity = cosineSimilarity;
    exports.createGrainRegistry = createGrainRegistry;
    exports.createProbabilityField = createProbabilityField;
    exports.delayedReward = delayedReward;
    exports.destroyGrain = destroyGrain;
    exports.discountReward = discountReward;
    exports.dotProduct = dotProduct;
    exports.euclideanDistance = euclideanDistance;
    exports.explorationRateFromEntropy = explorationRateFromEntropy;
    exports.explorationVsExploitation = explorationVsExploitation;
    exports.freezeGrain = freezeGrain;
    exports.getActiveGrains = getActiveGrains;
    exports.getAverageReward = getAverageReward;
    exports.getCurrentGrainId = getCurrentGrainId;
    exports.getGrainNavigationFn = getGrainNavigationFn;
    exports.getGrainRegistry = getGrainRegistry;
    exports.getGrainState = getGrainState;
    exports.getGrainsByType = getGrainsByType;
    exports.getHighestProbabilityOption = getHighestProbabilityOption;
    exports.getTotalReward = getTotalReward;
    exports.klDivergence = klDivergence;
    exports.magnitude = magnitude;
    exports.mergeProbabilityFields = mergeProbabilityFields;
    exports.navigateGrain = navigateGrain;
    exports.normalizeVector = normalizeVector;
    exports.normalizedEntropy = normalizedEntropy;
    exports.propagateRewardThroughChain = propagateRewardThroughChain;
    exports.propagateRewardToChildren = propagateRewardToChildren;
    exports.propagateRewardToParent = propagateRewardToParent;
    exports.propagateRewardToSiblings = propagateRewardToSiblings;
    exports.propagateRewardToType = propagateRewardToType;
    exports.punishGrain = punishGrain;
    exports.resetGrainRegistry = resetGrainRegistry;
    exports.sampleFromProbabilityField = sampleFromProbabilityField;
    exports.scaleVector = scaleVector;
    exports.setCurrentGrainId = setCurrentGrainId;
    exports.spawnGrain = spawnGrain;
    exports.subtractVectors = subtractVectors;
    exports.tuneVectorField = tuneVectorField;
    exports.updateGrainState = updateGrainState;
    exports.updateProbabilityField = updateProbabilityField;
    exports.useGrain = useGrain;
    exports.useGrainNavigation = useGrainNavigation;
    exports.useGrainReducer = useGrainReducer;
