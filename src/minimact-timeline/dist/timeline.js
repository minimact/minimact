var MinimactTimeline = (function (exports, core) {
    'use strict';
    ...
    function useTimeline(config, name) {
        const timelineRef = core.useRef(null);
        const [, forceUpdate] = core.useState(0);
    ...
    exports.SignalRTimelineSync = SignalRTimelineSync;
    exports.TimelineEngine = TimelineEngine;
    exports.VERSION = VERSION;
    exports.createSpawnWave = createSpawnWave;
    exports.useTimeline = useTimeline;
    exports.useTimelineEffect = useTimelineEffect;
    exports.useTimelineEffects = useTimelineEffects;
    exports.useTimelineGrain = useTimelineGrain;
