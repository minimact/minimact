 ...
 * ```
 */
export declare function useTimelineState<T>(timeline: TimelineEngine, stateKey: string, setter: (value: T) => void, interpolate?: boolean): void;
//# sourceMappingURL=useTimelineState.d.ts.map