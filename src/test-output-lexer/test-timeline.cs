...
public partial class AnimatedCounter : MinimactComponent
{
    ...
    protected override VNode Render()
    {
        ...
        var timeline = useTimeline({duration:5000,repeat:true,easing:"ease-in-out"});

        return new VElement("div", "1", new Dictionary<string, string>(), new VNode[]
        {
            new VElement("h1", "1.1", new Dictionary<string, string> { ["style"] = "" }, new VNode[]
            {
            ...
            new VElement("div", "1.2", new Dictionary<string, string>(), new VNode[]
            {
                ...
                new VElement("button", "1.2.2", new Dictionary<string, string> { ["onclick"] = "Handle1" }, "Play"),
                new VElement("button", "1.2.3", new Dictionary<string, string> { ["onclick"] = "Handle2" }, "Stop"),
                new VElement("button", "1.2.4", new Dictionary<string, string> { ["onclick"] = "Handle3" }, "Jump to Midpoint")
            })
        });
    }
