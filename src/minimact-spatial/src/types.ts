...
export type AreaDefinition =
  | string // Selector or special keyword ('viewport', 'window', 'document')
  | BoundsDefinition // Explicit coordinates
...
export interface AreaState {
  ...
  isFull: boolean; // coverage > 0.8

  /** Is area sparse (low density)? */
  isSparse: boolean; // density < threshold
}
