...
import type { AreaDefinition, BoundsDefinition, AbsoluteBounds } from './types';

/**
 * Calculate absolute bounds from area definition
 */
export function calculateBounds(definition: AreaDefinition): AbsoluteBounds {
 ...
 */
function calculateBoundsFromString(str: string): AbsoluteBounds {
  // Special keywords
 ...
 */
function calculateBoundsFromElement(element: Element): AbsoluteBounds {
 ...
 */
function calculateBoundsFromDefinition(def: BoundsDefinition): AbsoluteBounds {
 ...
 */
export function calculateDistance(a: AbsoluteBounds, b: AbsoluteBounds): number {
 ...
 */
export function isPartiallyEnclosed(
  element: DOMRect,
  area: AbsoluteBounds
): boolean {
